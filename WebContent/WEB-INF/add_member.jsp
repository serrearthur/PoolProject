                                ...
                                <div class="col-xs-12">
                                    <form action="" method="post" class="">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="input-lg form-control" id="name" name="memberName" placeholder="Nom" value="<c:out value="${param.memberName}"/>">
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Adresse Email</label>
                                            <input type="email" class="input-lg form-control" id="email" name="memberEmail" placeholder="Adresse Email" value="<c:out value="${param.memberEmail}"/>">
                                        </div>
                                        <div class="form-group">
                                            <label for="name">Date de naissance</label>
                                            <input type="text" class="input-lg form-control" id="birthdate" name="memberBirthdate" placeholder="Date de naissance (dd/mm/yyyy)" value="<c:out value="${param.memberBirthdate}"/>">
                                        </div>
                                        <div class="form-group">
                                            <label for="promotion">Promotion</label>
                                            <select class="input-lg form-control" id="promotion" name="memberPromotion">
                                            	<option></option>
